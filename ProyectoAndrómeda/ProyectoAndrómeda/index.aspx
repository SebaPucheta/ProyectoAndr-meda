        ...
        <div class="container">
           ...
           <div class="collapse navbar-collapse navbar-menubuilder" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a class="page-scroll" href="#gallery">Galeria</a>
                </li>
				...
				<div class="row">
					<div class="col-md-6 fadein scaleInv anim_1">
						<div class="fadein scaleInv anim_2">
							<h1 class="carouselText1 animated fadeInUpBig">Bienvenidos <span class="colortext">EDUCOM</span></h1>
						</div>
		...
		<div class="container animated fadeInUpNow notransition">
			<div class="row">
				<div class="col-md-3">
					...
					<p>
						Página de venta de apuntes en formato digital e impreso y venta de libros.
					</p>
					<p>
						 Sumamente profecionales.
					</p>
